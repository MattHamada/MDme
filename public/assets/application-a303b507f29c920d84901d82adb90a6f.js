...
(function() {
  ...
  jQuery(function() {
    return $('#appointments_date').datepicker({
      dateFormat: 'yy-mm-dd'
    });
  });

  jQuery(function() {
    return $('#date_day').datepicker({
      dateFormat: 'yy-mm-dd'
    });
  });
  ...
  APTS.getInfo = function() {
    $.ajax({
      ...
      error: function() {
        return alert("Error loading appointment");
      }
    });
    return false;
  };
